...
//************ file resize code with PHP end
 ...
 //getting the picture name from product table via product_id
 function getProductPicture($product_id){
   global $mysqli;
   $sql = "select picture from product where product_id=$product_id";
   $rs  = $mysqli->query($sql);
